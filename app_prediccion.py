...
class App:
    ...
    def __init__(self, ventana):
        ...
        self.lbl_rpt = Label(self.canvas,text="RESULTADO",font=("Arial", 40,"bold"),bg="#3D7695",fg="#ffffff",)
        self.lbl_rpt.place(x=0.0,y=250.0,width=300.0, height=100.0)
            ...
            for mano in resultado.multi_hand_landmarks:
                ...
                if len(posiciones) != 0:
                    ...
                    if dedos_reg.any():
                        ...
                        self.lbl_rpt.configure(text=self.dir_img[respuesta])
                        self.lbl_rpt.text=self.dir_img[respuesta]
                        #else:
                        #    self.lbl_rpt.configure(text='?')
                         #   self.lbl_rpt.text = '?'
